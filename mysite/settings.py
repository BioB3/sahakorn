...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS", cast=Csv(), default="localhost, 127.0.0.1, ::1, testserver"
)
...
CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS", cast=Csv(), default="http://localhost:5173, http://127.0.0.1:5173"
)